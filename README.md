...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    <tr valign="top">
      ...
      <td style="padding: 10px; border: 1px solid #88888855; width: 33%;">
        <p><strong>Built-in graphs:</strong> Frame Time, CPU Frame Time, GPU Frame Time, Render Thread Time, FPS, GC Memory, System RAM, Draw Calls, Batches, Triangles, Apx. Battery Drain Rate (registered in <a href="DevSuite/Assets/DevSuite/Runtime/DevSuiteContext.cs"><code>DevSuiteContext.Initialize</code></a>).</p>
